...
- 一些典型的 shebang line:
  ...
  - `#!/usr/bin/env python3`– 使用 [Python](https://en.wikipedia.org/wiki/Python_(programming_language) "Python（编程语言）") 解释器执行，使用 [env](https://en.wikipedia.org/wiki/Env "环境") 程序搜索路径找到它 [[)
